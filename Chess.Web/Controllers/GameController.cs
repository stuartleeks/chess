...
namespace Chess.Web.Controllers
{
    ...
    public class GameController : Controller
    {
        ...
        [Route("")]
        public ActionResult ChoosePiece()
        {
        ...
        public ActionResult ChooseEndPosition(string pieceSquareRef) // eg b3
        {
            var game = TheGame;
        ...
        public ActionResult Confirm(string pieceSquareRef, string endPosition)
        {
            var game = TheGame;
            var pieceReference = (Common.SquareReference)pieceSquareRef;
