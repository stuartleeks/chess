...
namespace Chess.Common.UnitTests
{
    ...
    public class GameMoves_TestBase
    {
        private string _board;
        protected void GivenBoard(string board)
        {
            _board = board;
        }
        ...
        protected void WithCurrentTurn(Color currentTurn)
        {
            _currentTurn = currentTurn;
        }
        protected void ThenMovesAre(params string[] moves)
        {
